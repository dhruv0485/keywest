...
export default function CoursePage() {
  ...
  return (
    <main className="w-full overflow-hidden bg-gradient-to-b from-black via-gray-900 to-black">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              {/* Course Curriculum CTA - Only for Level 1-4 */}
              {(course.level === "Level 1" || course.level === "Level 2" || course.level === "Level 3" || course.level === "Level 4") && (
      ...
      {/* Curriculum Modal - Only for Level 1-4 */}
      {(course.level === "Level 1" || course.level === "Level 2" || course.level === "Level 3" || course.level === "Level 4") && showCurriculumModal && (
        <div
