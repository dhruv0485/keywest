    ...
    <div className="bg-gradient-to-r from-primary/20 via-accent/15 to-secondary/20 border-b border-primary/30">
      <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 order-2 sm:order-1">
          <a href="https://www.instagram.com/keywestacademy.in?igsh=OGU1dGMxbW04OWpq" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-accent transition-all hover:scale-110" aria-label="Instagram">
